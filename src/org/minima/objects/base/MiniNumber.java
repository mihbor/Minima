...
public class MiniNumber implements Streamable, Comparable<MiniNumber> {
	 ...
	 */
	public static final int MAX_SIGNIFICANT_DIGITS = 34;
	
	/**
	 * The Maximum number of decimal places for ANY Minima Value
	 * 
	 * 10 digits represents 1 billion ( Max Value )..
	 */
	public static final int MAX_DECIMAL_PLACES = MAX_SIGNIFICANT_DIGITS - 10;
	...
	public MiniNumber divRoundDownWhole(MiniNumber zNumber) {
