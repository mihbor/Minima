...
public class MiniNumberTests {
    ...
    public void testValues() {
        ...
        assertNotNull("should not be null", l.divRoundDownWhole(MiniNumber.THOUSAND));
        System.out
                .println("l.divRoundDown(MiniNumber.THOUSAND) l:" + l + " value is " + l.divRoundDownWhole(MiniNumber.THOUSAND));
